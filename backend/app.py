...
GrowthInvestingList  = ['AMZN','VEEV','TER','NVDA','NFLX','VRTX','NOW','ADBE','QCOM'] 
...
def hometest(companyName):
    ...
    companies = ['DIS', 'NVO', 'MSFT', 'GOOGL', 'NEE', 'BEP', 'ENPH', 'AMZN', 'VEEV', 'TER', 'NVDA', 'NFLX', 'VRTX', 'NOW', 'ADBE', 'VTI', 'IXUS', 'QCOM',
